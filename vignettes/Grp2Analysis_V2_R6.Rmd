...
# Interactive density plots via plotly/ggplotly. Left panel: empirical
# abundances; right: transformed + normalized abundances. Hover a curve for the
# per-sample density; the legend toggles individual samples.
plotly::subplot(
  plotly::ggplotly(p1),
  plotly::ggplotly(p2),
  nrows = 1, titleX = TRUE, titleY = TRUE, margin = 0.05
)
...
cat(paste(
  "Furthermore, Figure \\@ref(fig:sigroteins) shows a co-clustered heatmap",
...
(ref:sigroteins) Heatmap of the proteins passing the FDR and difference thresholds. Cell colour encodes the row z-score of the $\log_2$ protein abundance (green: low, black: average, red: high; missing values in light gray). Proteins and samples are co-clustered by unsupervised hierarchical clustering (complete linkage, euclidean distance).
