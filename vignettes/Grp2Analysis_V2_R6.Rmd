...
The overall number of proteins including contaminant proteins in this experiment is: `r dea$summary$NrOfProteinsNoDecoys`.
The percentage of contaminant proteins is:`r dea$summary$percentOfContaminants` %. The percentage of false positive identifications (Decoy sequences) is `r dea$summary$percentOfFalsePositives` %.
