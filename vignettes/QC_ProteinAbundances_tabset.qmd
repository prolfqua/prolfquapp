...
<img src="`r knitr::image_uri(system.file("report-assets", "protein-abundances.png", package = "prolfquapp"))`" alt="Visual abstract: quantified protein signals are ranked by abundance, with dominant proteins and per-sample protein counts summarized across groups." style="width: 100%; max-height: 22rem; object-fit: contain;">
