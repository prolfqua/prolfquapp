...
<img src="visual_abstracts/quality-control-sample-size.png" alt="Visual abstract: pilot samples are quantified, quality checked for detection and variability, then used to plan sample size for a main experiment." style="width: 100%; max-height: 22rem; object-fit: contain;">
