...
<img src="`r knitr::image_uri(system.file("report-assets", "quality-control-sample-size.png", package = "prolfquapp"))`" alt="Visual abstract: pilot samples are quantified, quality checked for detection and variability, then used to plan sample size for a main experiment." style="width: 100%; max-height: 22rem; object-fit: contain;">
...
if ( moreThanOneSample ) {
  ...
  if (plot_density) {
    ...
    p2 <- stats$density_median() +
      ...
      ggplot2::labs(tag = "B") +
      ggplot2::xlim(0, 150)
    sized_widget(prolfquapp::plotly_ggplot_subplot(p1, p2, width = 600))
  } else {
