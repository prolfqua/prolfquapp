...
<img src="`r knitr::image_uri(system.file("report-assets", "differential-expression-qc.png", package = "prolfquapp"))`" alt="Visual abstract: quantified proteins are checked for missingness, variance, abundance distributions, and sample structure before differential-expression quality is assessed." style="width: 100%; max-height: 22rem; object-fit: contain;">
