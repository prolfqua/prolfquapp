...
#### Usage
    ...
    ProteinDataPrep$build_deanalyse(contrasts, default_model = "lm_missing")
...
#> INFO [2026-03-23 20:32:21] removing contaminants and reverse sequences with patterns: ^zz|^CON|Cont_^REV_|^rev_
data_prep$aggregate()
#> INFO [2026-03-23 20:32:21] AGGREGATING PEPTIDE DATA: medpolish.
...
#> INFO [2026-03-23 20:32:21] END OF PROTEIN AGGREGATION
data_prep$transform_data()
#> INFO [2026-03-23 20:32:21] Transforming using robscale.
#> Column added : log2_exp_medpolish
#> data is : TRUE
#> Joining with `by = join_by(protein_Id, sampleName, isotopeLabel)`
#> INFO [2026-03-23 20:32:21] Transforming data : robscale.
```
