...
- [`DEAnalyse`](https://prolfqua.github.io/prolfquapp/reference/DEAnalyse.md)
  ...
  classes
- [`DEAnalysePeptideToProtein`](https://prolfqua.github.io/prolfquapp/reference/DEAnalysePeptideToProtein.md)
  : Differential expression analysis from peptide input to protein
  output
...
- [`feature_annotation_get_best_score()`](https://prolfqua.github.io/prolfquapp/reference/feature_annotation_get_best_score.md)
  : get best feature annotation.
- [`filter_by_peptide_count()`](https://prolfqua.github.io/prolfquapp/reference/filter_by_peptide_count.md)
  : Drop proteins supported by fewer than \`nr_peptides\` distinct
  peptides
...
- [`plotly_ggplot_subplot()`](https://prolfqua.github.io/prolfquapp/reference/plotly_ggplot_subplot.md)
