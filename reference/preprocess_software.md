...
#> INFO [2026-07-03 08:59:39] Using derived sample display names in column 'sampleName'.
preprocess_functions <- prolfquapp::prolfqua_preprocess_functions[["DUMMY"]]
res <- preprocess_software(".", annot, preprocess_functions)
#> INFO [2026-07-03 08:59:39] Files data: data.path
#> INFO [2026-07-03 08:59:39] Files fasta: fasta.files.path
