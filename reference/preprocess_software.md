...
#> INFO [2026-06-09 13:59:26] Using derived sample display names in column 'sampleName'.
preprocess_functions <- prolfquapp::prolfqua_preprocess_functions[["DUMMY"]]
res <- preprocess_software(".", annot, preprocess_functions)
#> INFO [2026-06-09 13:59:26] Files data: data.path
#> INFO [2026-06-09 13:59:26] Files fasta: fasta.files.path
