...
#> INFO [2026-06-18 22:13:57] Using derived sample display names in column 'sampleName'.
preprocess_functions <- prolfquapp::prolfqua_preprocess_functions[["DUMMY"]]
res <- preprocess_software(".", annot, preprocess_functions)
#> INFO [2026-06-18 22:13:57] Files data: data.path
#> INFO [2026-06-18 22:13:57] Files fasta: fasta.files.path
