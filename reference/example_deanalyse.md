...
#> INFO [2026-03-23 19:48:14] removing contaminants and reverse sequences with patterns: ^zz|^CON|Cont_^REV_|^rev_
#> INFO [2026-03-23 19:48:14] AGGREGATING PEPTIDE DATA: medpolish.
#> Column added : log_abundance
#> starting aggregation
#> Column added : exp_medpolish
#> INFO [2026-03-23 19:48:14] END OF PROTEIN AGGREGATION
#> INFO [2026-03-23 19:48:14] Transforming using robscale.
#> Column added : log2_exp_medpolish
#> data is : TRUE
#> Joining with `by = join_by(protein_Id, sampleName, isotopeLabel)`
#> INFO [2026-03-23 19:48:14] Transforming data : robscale.
#> INFO [2026-03-23 19:48:14] model formula: normalized_abundance ~ group_
#> Joining with `by = join_by(protein_Id)`
