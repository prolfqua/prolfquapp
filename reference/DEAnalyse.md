...
#> INFO [2026-06-02 20:21:43] removing contaminants and reverse sequences with patterns: ^zz|^CON|Cont_^REV_|^rev_
data_prep$aggregate()
#> INFO [2026-06-02 20:21:43] AGGREGATING PEPTIDE DATA: medpolish.
#> Column added : log_abundance
#> starting aggregation
#> completing cases
#> Column added : exp_medpolish
#> INFO [2026-06-02 20:21:44] END OF PROTEIN AGGREGATION
data_prep$transform_data()
#> INFO [2026-06-02 20:21:44] Transforming using robscale.
#> Column added : log2_exp_medpolish
#> data is : TRUE
#> Joining with `by = join_by(sampleName, isotopeLabel, protein_Id)`
#> INFO [2026-06-02 20:21:44] Transforming data : robscale.

deanalyse <- data_prep$build_deanalyse(contrasts)
deanalyse$build_default()
#> INFO [2026-06-02 20:21:44] model formula: normalized_abundance ~ group_
