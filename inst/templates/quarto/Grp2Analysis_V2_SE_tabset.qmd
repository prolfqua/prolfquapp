...
dt_table(variance_summary, caption = "Variance quantile summary", page_length = 15)
```
...
#| fig-cap: "Transformed feature abundance row z-scores for significant differential-abundance results."
#| fig-width: 9
#| fig-height: 8
