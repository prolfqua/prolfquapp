...
(ref:vennDiagram) Venn diagram showing the number of significant proteins for each contrast and their intersections.


```{r vennDiagram, fig.cap="(ref:vennDiagram)", eval = showSignificant}
library(tidyverse)
xx <- split(datax$protein_Id, datax$contrast)
if (length(xx) > 1) {
