...
datax <- datax |> tidyr::unite("ID" , hkey, sep = "~")
...
ctdata <- datax_signif |> tidyr::unite("ID", hkey, sep = "~")
ctdata <- datax_signif |> dplyr::select(all_of(c("ID" ,  "description", "contrast", "modelName", "diff", "FDR"  ))) |> as.data.frame()
