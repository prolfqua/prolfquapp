...
precabund_table <- precabund_table |>
  dplyr::select(
    all_of(c(protID, "nrPeptides",
             ...
             "nrMeasured", "meanAbundance", "signal_percent" ,"description")))
if (factors) {
  precabund_table <- precabund_table |> 
    tidyr::pivot_wider(names_from = tableconfig$factor_keys_depth(), values_from = c("nrMeasured", "meanAbundance", "signal_percent"))
} else {
