...
(ref:sigroteins) Heatmap showing the $\log_2$ transformed empirical protein abundances for prays which pass the FDR and difference thresholds.
...
- `ORA_Bait_<contrast_name>.txt` proteins accepted with the FDR and difference threshold.
