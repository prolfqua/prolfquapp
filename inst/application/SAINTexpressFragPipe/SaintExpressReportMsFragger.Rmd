...
All resulting candidate lists are filtered using an Bayesian false discovery rate (BFDR) threshold of `r SEP$BFDRthreshold` and an  empirical fold-change score (EFC) threshold of `r SEP$FCthreshold` which corresponds to a $\log_2(EFC)$ of `r log2(SEP$FCthreshold)`.
