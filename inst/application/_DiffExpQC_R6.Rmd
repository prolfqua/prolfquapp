...
sr <- dea$lfq_data$get_Summariser()
...
st <- dea$lfq_data_transformed$get_Stats()
pC <- st$violin() +
  ggplot2::theme_classic() +
  ggplot2::labs(tag = "C") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, hjust = 1))

lfqData <- dea$lfq_data
...
cpl <- dea$contrast_results[[dea$default_model]]$get_Plotter(FCthreshold = cfg$processing_options$diff_threshold, FDRthreshold = cfg$processing_options$FDR_threshold)
