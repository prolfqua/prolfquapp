...
#' @param GRP2 ProlfquAppConfig configuration object
#' @export
#'
#' @examples
#' # example code
...
#' @param write if TRUE write files to disk
#' @export
#' @family workflow
#'
...
#' @param grp2 ProlfquAppConfig configuration with results
...
#' @param ORA if TRUE write ORA gene lists
#' @param GSEA if TRUE write GSEA rank files
#' @param markdown Rmd template to render
