...
*broom(v.1.0.12)*, *cellranger(v.1.1.0)*, *SparseArray(v.1.12.2)*,
...
*dtplyr(v.1.3.3)*, *lobstr(v.1.2.1)*, *S4Vectors(v.0.50.0)*,
...
*DelayedArray(v.0.38.1)*, *optparse(v.1.8.2)*, *tools(v.4.6.0)*,
...
*XVector(v.0.52.0)*, *BiocGenerics(v.0.58.0)*, *ggrepel(v.0.9.8)*,
*foreach(v.1.5.2)*, *pillar(v.1.11.1)*, *stringr(v.1.6.0)*,
*limma(v.3.68.1)*, *later(v.1.4.8)*, *splines(v.4.6.0)*,
...
*SummarizedExperiment(v.1.42.0)*, *stats4(v.4.6.0)*, *xfun(v.0.57)*,
*prolfqua(v.1.6.1)*, *Biobase(v.2.72.0)*, *statmod(v.1.5.1)*,
