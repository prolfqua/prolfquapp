...
*compiler(v.4.6.0)*, *bit64(v.4.8.2)*, *withr(v.3.0.2)*,
*pander(v.0.6.6)*, *S7(v.0.2.2)*, *backports(v.1.5.1)*,
*logger(v.0.4.2)*, *UpSetR(v.1.4.1)*, *pan(v.1.9)*, *MASS(v.7.3-65)*,
*DelayedArray(v.0.38.2)*, *optparse(v.1.8.2)*, *tools(v.4.6.0)*,
...
*limma(v.3.68.3)*, *later(v.1.4.8)*, *splines(v.4.6.0)*,
*lattice(v.0.22-9)*, *survival(v.3.8-6)*, *bit(v.4.6.0)*,
*tidyselect(v.1.2.1)*, *knitr(v.1.51)*, *reformulas(v.0.4.4)*,
*gridExtra(v.2.3)*, *prolfquapp(v.2.0.16)*, *bookdown(v.0.46)*,
